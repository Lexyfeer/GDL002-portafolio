      ...
      <Fragment>
        <div className="contentHome">
          ...
          <div className="-txtHome">
            <p>El desarrollo de este proyecto esta inspirado en los años 80s, y el juego de <a target="_blank" href="https://www.youtube.com/watch?v=mnhZ19G_2YI">Double Dragon ( No lo conoces, haz click aquí )</a>, ¡los colores neon me encantan!.</p>
